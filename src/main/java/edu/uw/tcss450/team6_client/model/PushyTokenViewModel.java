...
public class PushyTokenViewModel extends AndroidViewModel{
    ...
    /** The mutable live data for a pushy token */
    private final MutableLiveData<String> mPushyToken;

    /** The mutable live data for a JSON response object */
    private final MutableLiveData<JSONObject> mResponse;

    /**
     * The pushy token view model constructor class.
    ...
    /**
     * Add an HTTP response observer object to this view model
     * @param owner This lifecycle owner
     * @param observer The observer observing this json object response
     */
    ...
    /**
     * Retrieve the token from the pushy server
     */
